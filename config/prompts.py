...
"""
    ...
    def _get_document_analysis_prompt(self) -> str:
        ...
        return """Ты — высокоточный робот-ассистент для разметки документов. Твоя единственная задача — следовать инструкциям с абсолютной точностью. Не думай, не интерпретируй, просто выполняй.
