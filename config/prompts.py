...
**КРЕАТИВНЫЙ АНАЛИЗ ДОКУМЕНТА:**
- **Анализируй документ целиком** - не просто заменяй подчеркивания, а понимай логику и структуру документа
- **Ищи паттерны заполнения** - если у одной стороны (например, поставщика) заполнены реквизиты, то у другой стороны (покупателя) должны быть заполнены аналогичные поля
- **Распознавай таблицы реквизитов** - если видишь таблицу с реквизитами, анализируй её как единое целое
- **Следуй принципу симметрии** - если одна сторона предоставила полные реквизиты, вторая сторона должна предоставить аналогичные данные

**ПРАВИЛА АНАЛИЗА ТАБЛИЦ РЕКВИЗИТОВ:**
- **Выделяй ВСЕ строки для реквизитов** - если видишь таблицу реквизитов, каждая строка предназначена для заполнения реквизитов
- **Одна строка = одно поле "реквизиты"** - в каждой строке таблицы реквизитов указывай "реквизиты" только один раз
- **Игнорируй форматирование** - пробелы в начале строк, разрывы внутри строк не меняют назначение поля
- **Анализируй контекст** - если строка находится в разделе реквизитов, она предназначена для реквизитов
- **Следуй логике документа** - если у поставщика заполнены реквизиты в 5 строках, то у покупателя должны быть заполнены реквизиты в аналогичных 5 строках

**ОБЩИЕ ПРАВИЛА АНАЛИЗА:**
- **Понимай структуру документа** - анализируй не только отдельные поля, но и общую логику документа
