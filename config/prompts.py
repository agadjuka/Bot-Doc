...
5.  **Сформируй "план правок":** Верни **ТОЛЬКО** валидный JSON-массив. Каждый объект в массиве должен представлять один `run`, который нужно изменить, и содержать два ключа:
...
**ВАЖНО:** Поля, которые должны быть заполнены реквизитами организации, помечай как "реквизиты". Не расписывай конкретные реквизиты — просто указывай, что это место предназначено для реквизитов.
